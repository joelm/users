...
<div id="about" class="selectable">
    ...
    <p><strong>Candidate Assessment</strong><br>Version 1.0 beta<br>
        <a href="http://www.rulefinancial.com">By Joel Mahatsri</a></p>
    <p><em>Rule Financial<br> just HTML, CSS, and jQuery.</em></p>
    <p>
        <a target="_blank" href="http://twitter.com/jqtouch">@Rule on Twitter</a>
    </p>
...
<div id="createCandiateDiv">
    <div class="toolbar">
        <h1>Candidate Details</h1>
        <a href="#" class="back">Back</a>
    </div>

    <form action="/rucas-web/create" id="candidateForm" name="createCandidateForm" class="scroll">
        <ul class="edit rounded">
            <li><input type="text" name="name" placeholder="Name" id="candidate_name" /></li>
            <li><input type="search" name="search" placeholder="Search & Assign Assessments" id="assessments" /></li>
            <li><input type="tel" name="mobile" placeholder="Phone" id="mobile"  /></li>
            <li><input type="text" name="postcode" placeholder="Postocde" id="postcode" /></li>
...
<%--            <li>Sample Toggle <span class="toggle"><input type="checkbox" /></span></li>
            ...
            <li><input type="checkbox" name="food" value="architect" title="Architect" /></li>
   <%--         <li><input type="checkbox" name="food" value="pie" checked="checked" title="Pie" /></li>
        ...
        <a href="#" id="createCanBtn" class="whiteButton">Create </a>
    </form>
</div>
<!-- END Create Candidate Form -->
...
<div id="home" class="current">
    ...
    <div class="scroll">
        <ul class="rounded">
            <li class="arrow"><a href="#ui">Candidates <small class="counter">5</small></a> </li>
        ...
        <ul class="rounded">
            <li class="forward"><a target="_blank" href="http://www.jqtouch.com/">Assessment</a></li>
        </ul>
        <ul class="individual">
            <li><a target="_blank" href="http://twitter.com/!#/rulefinancial">@rulefinancial</a></li>
            <li><a target="_blank" href="http://twitter.com/!#/joelmahatsri">@joelmahatsri</a></li>
        </ul>
        <div class="info">
...
<div id="ui">
    ...
    <div class="scroll">
        ...
        <ul class="rounded">
            <li class="arrow"><a href="#createCandiateDiv">Create</a></li>
            <li class="arrow"><a href="#">Search</a></li>
            <li class="arrow"><a href="#">Browse</a></li>
        </ul>
        <h2>Lists</h2>
        <ul class="rounded">
...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/jqtouch.css" />" />

<script src="<c:url value='/resources/js/zepto.min.js'/>"></script>
<script src="<c:url value='/resources/js/jqtouch.min.js'/>"></script>

<!-- Uncomment the following two lines (and comment out the previous two) to use jQuery instead of Zepto. jquery.json-2.4.js-->
<script src="<c:url value='/resources/js/jquery-1.7.min.js'/>"></script>
<script src="<c:url value='/resources/js/jqtouch-jquery.min.js'/>"></script>
<script src="<c:url value='/resources/js/jquery.json-2.4.js'/>"></script>

<script src="<c:url value='/resources/js/extensions/jqt.themeswitcher.min.js'/>"></script>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#createCanBtn").click(function(event) {
            event.preventDefault();


            var form =  $("form#candidateForm").serializeArray();
            console.log(form);

            var jsonEncoded = $.toJSON( form );
            console.log(jsonEncoded);

            url = "create";

            /* Send the data using post */
            var posting = $.post( url, { candidate : jsonEncoded } );

            $("form#candidateForm").each(function() {
            ...
            $("form#candidateForm :input").each(function(){
